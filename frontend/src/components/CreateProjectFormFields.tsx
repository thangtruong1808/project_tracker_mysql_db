/**
 * CreateProjectFormFields Component
 * Form input fields for creating a new project with react-hook-form validation
 *
 * @author Thang Truong
 * @date 2024-12-24
 */
...
/**
 * CreateProjectFormFields Component
 * Renders form input fields for project creation with validation
 *
 * @param register - react-hook-form register function
 * @param errors - Form validation errors
 * @returns JSX element containing form fields
 */
const CreateProjectFormFields = ({ register, errors }: CreateProjectFormFieldsProps) => {
  return (
