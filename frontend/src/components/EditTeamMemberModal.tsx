 ...
 * Modal form for updating team member role
 *
 * @author Thang Truong
 * @date 2024-12-24
 */
...
import { UPDATE_TEAM_MEMBER_MUTATION } from '../graphql/mutations'
import { TEAM_MEMBERS_QUERY, PROJECTS_QUERY, USERS_QUERY } from '../graphql/queries'
import EditTeamMemberFormFields from './EditTeamMemberFormFields'
...
const EditTeamMemberModal = ({ member, isOpen, onClose, onSuccess }: EditTeamMemberModalProps) => {
  ...
  const [updateTeamMember] = useMutation(UPDATE_TEAM_MEMBER_MUTATION, {
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50 p-4">
      <div className="bg-white rounded-lg shadow-xl max-w-2xl w-full max-h-[90vh] overflow-y-auto">
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="p-6">
          <EditTeamMemberFormFields register={register} errors={errors} projects={projects} users={users} />
