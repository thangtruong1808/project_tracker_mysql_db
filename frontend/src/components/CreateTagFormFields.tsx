/**
 * CreateTagFormFields Component
 * Form input fields for creating a new tag with react-hook-form validation
 *
 * @author Thang Truong
 * @date 2024-12-24
 */
...
interface CreateTagFormFieldsProps {
  register: UseFormRegister<CreateTagFormData>
  errors: FieldErrors<CreateTagFormData>
}

/**
 * CreateTagFormFields Component
 * Renders form input fields for tag creation with validation
 *
 * @param register - react-hook-form register function
 * @param errors - Form validation errors
 * @returns JSX element containing form fields
 */
const CreateTagFormFields = ({ register, errors }: CreateTagFormFieldsProps) => {
  return (
...
export default CreateTagFormFields
