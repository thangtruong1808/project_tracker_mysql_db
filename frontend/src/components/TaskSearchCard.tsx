          ...
          <div className="flex items-center gap-2 min-w-0">
            ...
            <div className="flex flex-col leading-tight min-w-0">
              <span className="truncate">
                {owner ? `${owner.firstName} ${owner.lastName}` : 'Assignee not set'}
              </span>
              <span className="text-[11px] text-gray-500">{owner?.role || 'Role unavailable'}</span>
            </div>
          </div>
