/**
 * ProjectsTableLoading Component
 * Loading skeleton for projects table during data fetch
 *
 * @author Thang Truong
 * @date 2024-12-24
 */
        ...
        {mobileCards.map((_, index) => (
          <div key={index} className="bg-gray-50 rounded-lg p-4 border border-gray-200">
            <div className="flex items-start justify-between mb-3">
              ...
              <div className="ml-2 h-5 bg-gray-200 rounded-full w-1/4 flex-shrink-0"></div>
            </div>
