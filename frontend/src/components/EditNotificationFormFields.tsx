/**
 * EditNotificationFormFields Component
 * Form input fields for editing notification information with react-hook-form validation
 *
 * @author Thang Truong
 * @date 2024-12-24
 */
...
interface EditNotificationFormFieldsProps {
  register: UseFormRegister<EditNotificationFormData>
  errors: FieldErrors<EditNotificationFormData>
  users: Array<{ id: string; firstName: string; lastName: string }>
}

/**
 * EditNotificationFormFields Component
 * Renders form input fields for notification editing with validation
 *
 ...
 */
const EditNotificationFormFields = ({ register, errors, users }: EditNotificationFormFieldsProps) => {
  return (
...
export default EditNotificationFormFields
