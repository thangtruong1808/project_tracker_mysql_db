/**
 * ActivityLogsTableLoading Component
 * Loading skeleton shown while activity logs data is fetching
 *
 * @author Thang Truong
 * @date 2024-12-24
 */
...
/**
 * ActivityLogsTableLoading Component
 * Renders placeholder skeletons for desktop, tablet, and mobile layouts
 */
const ActivityLogsTableLoading = () => {
...
export default ActivityLogsTableLoading
