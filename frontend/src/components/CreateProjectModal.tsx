 ...
 * Modal dialog for creating a new project with react-hook-form validation
 *
 * @author Thang Truong
 * @date 2024-12-24
 */
...
import CreateProjectFormFields from './CreateProjectFormFields'
...
/**
 * CreateProjectModal Component
 * Renders a modal form for creating a new project with react-hook-form validation
 *
 * @param isOpen - Whether the modal is open
 * @param onClose - Callback when modal is closed
 * @param onSuccess - Callback when project is successfully created
 * @returns JSX element containing create project modal
 */
const CreateProjectModal = ({ isOpen, onClose, onSuccess }: CreateProjectModalProps) => {
   ...
   * Refetches projects list after successful creation
   */
   ...
   * Creates new project upon successful validation
   *
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50 p-4">
      <div className="bg-white rounded-lg shadow-xl max-w-lg w-full max-h-[90vh] overflow-y-auto">
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="p-6">
          <CreateProjectFormFields register={register} errors={errors} />
