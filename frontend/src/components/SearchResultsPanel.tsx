 ...
 * Displays paginated search results for projects and tasks in a grid layout (4 cards per row)
 *
 * @author Thang Truong
 * @date 2025-01-27
 */
...
/**
 * SearchResultsPanel Component
 * Renders sections for projects and tasks in a responsive grid layout
 * Displays 4 cards per row on desktop, 2 on tablet, 1 on mobile
 *
 * @author Thang Truong
 * @date 2025-01-27
 */
const SearchResultsPanel = ({
   ...
   * Displays helpful message to guide users
   *
   * @author Thang Truong
   * @date 2025-01-27
   */
      ...
      <div className="mt-8">
        <div className="rounded-xl border border-dashed border-gray-300 bg-gray-50 px-6 py-12 text-center">
          ...
          <p className="text-sm text-gray-500">
            Use the search drawer to filter projects and tasks by keyword or status
          </p>
        </div>
      </div>
    )
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-gray-500 mt-0.5">
                {projectTotal === 0
                  ? 'No projects found'
                  : `${projectTotal} ${projectTotal === 1 ? 'project' : 'projects'} found`}
              </p>
            </div>
          </div>
        </header>
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-gray-500 mt-0.5">
                {taskTotal === 0
                  ? 'No tasks found'
                  : `${taskTotal} ${taskTotal === 1 ? 'task' : 'tasks'} found`}
              </p>
            </div>
          </div>
        </header>
