...
import ProjectsTableTablet from './ProjectsTableTablet'
...
/**
 * ProjectsTable Component
 * Renders a sortable table of projects with edit and delete actions
 *
 ...
 * @returns JSX element containing projects table
 */
const ProjectsTable = ({
  projects,
  sortField,
  ...
  if (projects.length === 0) {
    return (
      <div className="bg-white rounded-lg shadow-md p-8 sm:p-12 text-center">
        ...
        <p className="text-sm sm:text-base text-gray-600">No projects to display</p>
      </div>
    )
  }
  ...
  return (
    <div className="bg-white rounded-lg shadow-md overflow-hidden">
            ...
            {projects.map((project) => (
              <tr key={project.id} className="hover:bg-gray-100 transition-colors">
                ...
                <td className="px-4 xl:px-6 py-4 text-sm text-gray-700 max-w-xs">
                  <div className="truncate">{project.description || 'N/A'}</div>
                </td>
                ...
                <td className="px-4 xl:px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                  {formatDateToMelbourne(project.createdAt)}
                </td>
                <td className="px-4 xl:px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                  {formatDateToMelbourne(project.updatedAt)}
                </td>
      ...
      <div className="md:hidden">
        <ProjectsTableMobile projects={projects} onEdit={onEdit} onDelete={onDelete} />
      </div>
    </div>
  )
}
