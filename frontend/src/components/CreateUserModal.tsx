 ...
 * Modal dialog for creating a new user with react-hook-form validation
 *
 * @author Thang Truong
 * @date 2024-12-24
 */
...
/**
 * CreateUserModal Component
 * Renders a modal form for creating a new user with react-hook-form validation
 *
 * @param isOpen - Whether the modal is open
 * @param onClose - Callback when modal is closed
 * @param onSuccess - Callback when user is successfully created
 * @returns JSX element containing create user modal
 */
const CreateUserModal = ({ isOpen, onClose, onSuccess }: CreateUserModalProps) => {
   ...
   * Refetches users list after successful creation
   */
   ...
   * Creates new user account upon successful validation
   *
   * @param data - Form data containing firstName, lastName, email, password, and role
   */
