 ...
 * Simplified setup for Apollo Client 3.14.0 compatibility
 * Uses direct link composition to avoid Error 69
 *
 * @author Thang Truong
 * @date 2025-01-27
 */
...
try {
  // For Apollo Client 3.14.0, use direct link composition
  // Chain: errorLink -> authLink -> httpLink
  // This is the most reliable approach for version 3.14.0
  const linkChain = from([errorLink, authLink, httpLink])
